...
const DetailsCard = ({ item, index }) => {
  const { name, color, target, image, reservations_count } = item;
      ...
      >
        <div className={`bg-${color}/10  relative p-6 pt-12 rounded`}>
          ...
          <div className="flex flex-col items-center gap-2 ">
            ...
            <Badge className="bg-primary/90">{reservations_count > 0 ? reservations_count + " Sessions" : reservations_count + " Session"}</Badge>
          </div>
