...
export const updateUserDataFromResponse = (response) => {
  try {
    // Handle the specific response structure you provided
    if (response.status && response.data) {
      ...
      // Return the updated data for further use
    ...
    console.error('Error updating user data from response:', error);
    return null;
  }
};
...
export const getDefaultRouteForRole = (role) => {
  // Always redirect to dashboard home for all roles
      return '/dashboard';
};
